function Table_PositionProfile(curr_fig, cfighandles )
      ...
      if ~isempty(reports)
        ...
        if updatetable || max(reports.orders(1:osize,rcol.id))>lastid
          ...
          ordersdata(:,1) = ...
            ...
            reports.ordersprofile(:,rcol.time)),'HH:mm:ss.fff'));
          ordersdata(:,2) = ...
            num2cell(flipud(reports.ordersprofile(:,rcol.ordtype)));
          ordersdata(:,3) = ...
            num2cell(flipud(reports.ordersprofile(:,rcol.tag)));
          ordersdata(:,4) = ...
            num2cell(flipud(reports.ordersprofile(:,rcol.price)));
          ordersdata(:,5) = ...
            num2cell(flipud(reports.ordersprofile(:,rcol.value)));
          ordersdata(:,6) = ...
            num2cell(flipud(reports.ordersprofile(:,rcol.orderid)));
          ordersdata(:,7) = ...
            num2cell(flipud(reports.ordersprofile(:,rcol.requestid)));
          ordersdata(:,8) = ...
            num2cell(flipud(reports.ordersprofile(:,rcol.id)));
