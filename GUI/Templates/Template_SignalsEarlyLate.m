function Template_SignalsEarlyLate(curr_fig, cfighandles, Market)
    ...
    if ~isempty(position)
      ...
      if ns>0 
        ...
        if ~isempty(nzidx)
          ...
          bar(cfighandles.ax_volume_price,centers,counts,'g');
        end
      end
    end
    ...
    if ~isempty(position)
      ...
      if ns>0 
        netslippage = ...
          ...
          -symbol.positions.rlogaccumearly(np,1:quotes.lastbar(n,end))...
          -symbol.positions.rlogaccumlate(np,1:quotes.lastbar(n,end));
        ...
        'm','LineWidth',2);
      stairs(cfighandles.ax_time_volume,...
        [1:quotes.lastbar(n,end)],netslippage,...
        'y','LineWidth',2);
      legend(cfighandles.ax_time_volume,...
        {'Early Close','Late Close','Slippage'},...
        'Color',[0 0 0],'TextColor',[1 1 1],'FontSize',16);
      end
    end
